...
<html>
<head>
<title>Institution - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Our Institution</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="#" class="qwklink">Our Institution</a>
	</div>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					...
					<h5 class="bodyhdtxt">Goals of the Institution</h5>
					<ol>
						<li>To remove the superstitious belief and develop scientific and curative attitude in the students.</li>
						<li>To give employment oriented education to the students.</li>
						<li>To give career- oriented education to the students.</li>
						<li>To develop over all personality of the students.</li>
						<li>To provide educational facilities to the rural student at a reasonable cost.</li>
						<li>To provide education to the students of socially & economically backward class.</li>
						<li>To create a generation of scientist who shall dedicate themselves to the research works.</li>
						<li>To increase the provision of medical specialists for the physical and mental fitness of the Society.</li>
						<li>To create expert man power for the subject, International Business</li>
						<li>To create Successful teachers among the students.</li>
						<li>To guide for the succession competitive exams.</li>
						<li>To create national charactered professional experts.</li>
						<li>To create responsible citizen towards social outlook.</li>
						<li>To create expert skilled and good charactered teachers in the field of education.</li>
					</ol>
				</div>
			</div>
			<!-- left div end -->
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="#"><div class="rightbtn">Our Institution</div></a>
					<a href="principal.php"><div class="rightbtn">Principal's Message</div></a>
					<a href="#"><div class="rightbtn">Activities</div></a>
				</div>
			</div>
			<!-- right div end -->
