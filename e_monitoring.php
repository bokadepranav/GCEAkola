...
<html>
<head>
<title>E-Monitoring - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">E-Monitoring</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">E-Monitoring</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<h5 class="bodyhdtxt" align="center">E-MONITORING, Teacher Education Institution Reports</h5>
					<table width="100%">
						...
						<tr align="center">
							<td class="tblbd">1</td>
							<td class="tblbd">ASSESSOR’S Report</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">2</td>
							<td class="tblbd">Student Report</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>	
					</table>
				</div>
