...
<html>
<head>
<title>Principal's Message - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Principal's Message</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Principal's Message</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="institution_page.php"><div class="rightbtn">Our Institution</div></a>
					<a href="#"><div class="rightbtn">Principal's Message</div></a>
