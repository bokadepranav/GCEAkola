...
<html>
<head>
<title>Computer Lab - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Computer Lab</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Computer Lab</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<p>
						In todays competitive edge computer knowledge is essential for every branch of education. We wish to make all our student computer literate. Attending computer classes are compulsary for every student.<br><br>

						Well equipde computor lab is an asset of our college. Computer lab has number of present generation computers for the use of students & Staff. We follow our designed need based computer curriculum to suit the requirement of 21st century teachers.					
					</p>
					<table width="100%">
						...
						<tr align="center">
							<td class="tblbd">1</td>
							<td class="tblbd">Computer</td>
							<td class="tblbd">25</td>
						</tr>
						<tr align="center">
							<td class="tblbd">2</td>
							<td class="tblbd">Laptop</td>
							<td class="tblbd">9</td>
						</tr>
						<tr align="center">
							<td class="tblbd">3</td>
							<td class="tblbd">LCD Projector</td>
							<td class="tblbd">9</td>
						</tr>
						<tr align="center">
							<td class="tblbd">4</td>
							<td class="tblbd">Film Strip Projector</td>
							<td class="tblbd">1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">5</td>
							<td class="tblbd">Slide Projector</td>
							<td class="tblbd">1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">6</td>
							<td class="tblbd">Overhead Projector</td>
							<td class="tblbd">3</td>
						</tr>
						<tr align="center">
							<td class="tblbd">7</td>
							<td class="tblbd">Printer</td>
							<td class="tblbd">5</td>
						</tr>
						<tr align="center">
							<td class="tblbd">8</td>
							<td class="tblbd">Scanner</td>
							<td class="tblbd">1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">9</td>
							<td class="tblbd">Television</td>
							<td class="tblbd">2</td>
						</tr>
						<tr align="center">
							<td class="tblbd">10</td>
							<td class="tblbd">VCD / DVD Player</td>
							<td class="tblbd"></td>
						</tr>
						<tr align="center">
							<td class="tblbd">11</td>
							<td class="tblbd">Audio Casette Player / Casettes</td>
							<td class="tblbd">3 / 30</td>
						</tr>
						<tr align="center">
							<td class="tblbd" colspan="3">Internet facility is available for all.</td>
						</tr>				
					</table>
					<br>
					<img src="image/computer.jpg" class="bdimg">
				</div>
			</div>
			<!-- left div end -->
