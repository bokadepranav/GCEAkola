...
<html>
<head>
<title>RTI - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Right To Information Act</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">RTI Act</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="#"><div class="rightbtn">Right to Information Act</div></a>
					<a href="#"><div class="rightbtn">Download RTI Act</div></a>
					<a href="#"><div class="rightbtn">Public Information Officer</div></a>
					<a href="#"><div class="rightbtn">Process</div></a>
				</div>
			</div>
			<!-- right div end -->
