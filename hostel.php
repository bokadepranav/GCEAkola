...
<html>
<head>
<title>Hostel - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Hostel</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<h5 style="color: rgb(94, 12, 12); text-align: center;">Girls Hostel</h5><br>
					<img src="image/hostel1.jpg" class="bdimg" alt="..."><br><br>
					<h5 style="color: rgb(94, 12, 12); text-align: center;">Boys Hostel</h5><br>					    
					<img src="image/hostel2.jpg" class="bdimg" alt="...">
				</div>
			</div>
			<!-- left div end -->
