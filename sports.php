...
<html>
<head>
<title>Sports - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Sports</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<p>
						The Institute provides different types of sports coaching for development of fututre teachers. Through sports training the students learns the spirit of self sacrifice and devotion to the interest of the group. We have special Sports facilities room in our institution to boost the moral of students and keep them ahead in sports.
					</p>
					<h5 style="color: rgb(94, 12, 12);">Play Ground</h5><br>
					<p>
						A lage and nice playground is available for institution. keeping in mind the health is wealth we encourage our students to play outdoor games for their overall development.
					</p>
					<img src="image/ground.jpg" class="bdimg">
				</div>
			</div>
			<!-- left div end -->
