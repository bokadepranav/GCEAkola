...
<html>
<head>
<title>Document - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Documents</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Financial Management</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<ol>
						<li><a href="" id="bodytxt">N.C.E.T. Letter (pdf)</a></li>
						<li><a href="" id="bodytxt">S.G.B.A.U. Affiliation (pdf)</a></li>
						<li><a href="" id="bodytxt">Mandatory Disclosure (pdf)</a></li>
						<li><a href="" id="bodytxt">Affidavit (pdf)</a></li>
						<li><a href="" id="bodytxt">Affidavit2 (pdf)</a></li>
						<li><a href="" id="bodytxt">Vision Document (pdf)</a></li>
					</ol>
				</div>
			</div>
			<!-- left div end -->
