...
<html>
<head>
<title>Et Lab - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Et Lab</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<h5 style="color: rgb(94, 12, 12);">Audio - Visual Aids</h5><br>
					<p>
					...
					<table width="100%">
						...
						<tr align="center">
							<td class="tblbd">1</td>
							<td class="tblbd">Radio</td>
						</tr>		
						<tr align="center">
							<td class="tblbd">2</td>
							<td class="tblbd">Tape recorder</td>
						</tr>
						<tr align="center">
							<td class="tblbd">3</td>
							<td class="tblbd">DVD Player</td>
						</tr>
						<tr align="center">
							<td class="tblbd">4</td>
							<td class="tblbd">O.H.P.</td>
						</tr>
						<tr align="center">
							<td class="tblbd">5</td>
							<td class="tblbd">TV 1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">6</td>
							<td class="tblbd">VCR 1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">7</td>
							<td class="tblbd">Sound system</td>
						</tr>
						<tr align="center">
							<td class="tblbd">8</td>
							<td class="tblbd">Digital Camera</td>
						</tr>
						<tr align="center">
							<td class="tblbd">9</td>
