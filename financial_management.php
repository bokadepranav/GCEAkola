...
<html>
<head>
<title>Financial Management - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Financial Management</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<ol>
						<li><a href="" id="bodytxt">Financial Management (pdf)</a></li>
						<li><a href="" id="bodytxt">Balance Sheet (pdf)</a></li>
						<li><a href="" id="bodytxt">Income & Expenditure (pdf)</a></li>
						<li><a href="" id="bodytxt">Reciept & Payment (pdf)</a></li>
					</ol>
				</div>
			</div>
			<!-- left div end -->
