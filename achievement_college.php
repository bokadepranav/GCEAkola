...
<html>
<head>
<title>Achievements College - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Achievements - College</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<div>
						NACC Accreditation: B+NACC
					</div>
					<hr>
					<div>
						Organised State Level Conferenes.
						<ul>
							<li>Intellectual property rights and Education.</li>
							<li>Global Warming and Education - 2008.</li>
						</ul>
					</div>
					<hr>
					<div>
						Organised University level Seminar.
						<ul>
							<li>Education for Sustainable Development - 2010.</li>
						</ul>
					</div>
					<hr>
					<div>
						Stood First in Maharashtra in Following Exams :
						<ul>
							<li>M.ed. 2006</li>
							<li>DSM 2005</li>
						</ul>
					...
					<hr>
					<div>
						U.G.C. has granted Fund for Minor Research project to Eight Lectures.
					</div>
					<hr>
					<div>
						Dr.Rohani Tadas was member of Academic Council of Amravati University.
					</div>
					<hr>
					<div>
						Following faculties has published the books with ISBN:
						<ul>
							<li>Dr. Santaram Bute</li>
							<li>Dr. Vasudha Deo</li>
							<li>Dr. Mohan Khatal</li>
						</ul>
					</div>
					<hr>
					<div>
						Dr. Shantaram G. Bute is a mamber of academic council of UMU Jalgaon and YCMOU Nashik.
					</div>
					<hr>
					<div>
						Dr. Mohan Khatal is a mamber of academic council of SSC and HSC bord Pune.
					</div>
					<hr>
					<div>
						The Institute has been upgraded and has been recognized on CTE. The Central Government has sanctioned Rs. 5 Crores 62 Laks as a grant in aid for the construction of the College building.
					</div>
					<hr>
					<div>
						Dr.S.G.Bute
						<ul>
							<li>B.O.S. Member of Academic Council of U.M.U. Jalgaon.</li>
							<li>B.O.S. Member of Academic Council of Y.C.M.O.U. Nashik.</li>
						</ul>
					</div>
					<hr>
					<div>
						...
						<ul>
							<li>
								B.O.S. Member of Geography, Secondary and Higher Secondary Education bord , Pune.
							</li>
						</ul>
					</div>
					<hr>
					<div>
						Organised National Level Conferenes.
						<ul>
							<li>"No Transfusion Of Idea Only Transformation" On 2 & 3 Feb. 2015.</li>
							<li>"Integration of Value Education In Present Scenario" On 6 & 7 Feb. 2015.</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="#"><div class="rightbtn">Achievements-College</div></a>
					<a href="achievement_faculty.php"><div class="rightbtn">Achievements-Faculty</div></a>
