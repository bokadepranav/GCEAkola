...
<html>
<head>
<title>Faculty - Govt College Of Education</title>
...
.cardbd{
	background-color: rgba(94, 12, 12, 1);
}
#cardtxt{
	color: white;
	text-align: center;
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Faculty</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Administration</a>|
		<a href="" class="qwklink">Faculty</a>
	</div>
	...
	<div class="container">
		<div class="row">
				...
				<div class="leftdiv">
					<div class="row row-cols-1 row-cols-md-2 g-4">
					  <a href="">
					  	<div class="col">
						    <div class="card">
						      <center><img src="image/fac1.jpg" class="card-img-top cardimg" alt="..."></center>
						      <div class="card-body cardbd">
						        <h5 class="card-title" id="cardhd">Dr.Vasudha V. Deo</h5>
						        <p class="card-text" id="cardtxt">
						        	(Associate Professor)<br>
						        	M. Com. M.A. M.Ed. SET, Ph.D.
						        </p>
						      </div>
						    </div>
						  </div>
					  ...
					  <a href="">
					  	<div class="col">
						    <div class="card">
						      <center><img src="image/fac2.jpg" class="card-img-top cardimg" alt="..."></center>
						      <div class="card-body cardbd">
						        <h5 class="card-title" id="cardhd">Dr.Archana G. Watkar</h5>
						        <p class="card-text" id="cardtxt">
					  ...
					  <a href="">
					  	<div class="col">
						    <div class="card">
						      <center><img src="image/fac3.jpg" class="card-img-top cardimg" alt="..."></center>
						      <div class="card-body cardbd">
						        <h5 class="card-title" id="cardhd">Dr. Asha Madhukarrao Dharaskar</h5>
						        <p class="card-text" id="cardtxt">
						        	(Assistant Professor)<br>
						        	M.A.,M.Ed. M.Phil, Ph.d, DBCM
						        </p>
						      </div>
						    </div>
						  </div>
					  ...
					  <a href="">
					  	<div class="col">
						    <div class="card">
						      <center><img src="image/fac4.jpg" class="card-img-top cardimg" alt="..."></center>
						      <div class="card-body cardbd">
						        <h5 class="card-title" id="cardhd">Dr. Sandya U. Samudre</h5>
						        <p class="card-text" id="cardtxt">
						        	(Assistant Professor)<br>
						        	M.Sc., M.A., M.Ed. Ph.D.
						        </p>
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="faculty.php"><div class="rightbtn">Faculty</div></a>
					<a href="#"><div class="rightbtn">Non Teaching Staff</div></a>
					<a href="#"><div class="rightbtn">Teaching Staff</div></a>
					<a href="#"><div class="rightbtn">C.H.B. Teaching Staff</div></a>
					<a href="#"><div class="rightbtn">Teaching Staff Left</div></a>
					<a href="#"><div class="rightbtn">Non Teaching Staff</div></a>
				</div>
			</div>
			<!-- right div end -->
