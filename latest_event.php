...
<html>
<head>
<title>Latest Event - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Latest Events</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Latest Event</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<h5 class="bodyhdtxt" align="center">Latest Events</h5>
					<table width="100%">
						<tr align="center" style="background-color: rgb(94, 12, 12); color: white; border-color: white;">
							<td class="tblbd"><b>S.n</b></td>
							<td class="tblbd"><b>Topic</b></td>
							<td class="tblbd"><b>Click To See</b></td>
						</tr>		
						<tr align="center">
							<td class="tblbd">1</td>
							<td class="tblbd">DIGITAL SKILLS FOR CREATIVE STUDENTSTEACHER (DISC)</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">2</td>
							<td class="tblbd">SYNOPSIS</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">3</td>
							<td class="tblbd" style="font-family: 'Hind', sans-serif;">निमंत्रण</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">4</td>
							<td class="tblbd">Flyer</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">5</td>
							<td class="tblbd" style="font-family: 'Hind', sans-serif;">निमंत्रण आर्ट ड्रामा	</td>
							<td class="tblbd"><a href="">Click To See</a></td>
						</tr>
					</table>
				</div>
