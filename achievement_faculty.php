...
<html>
<head>
<title>Achievements Faculty - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Achievements - Faculty</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">About</a>|
		<a href="" class="qwklink">Achievements</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<div>
						<b>Dr. S. G. Bute</b>
						<ul>
							<li>Topic of Research - A critical study of Educational Values in Sant Janabai’s Abhangas</li>
							<li>Year - 2008-2010</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 34000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>Dr. V. V. Deo</b>
						<ul>
							<li>Topic of Research - Analytical study of Educational Thoughts of Swami Chinamayanand with reference to new curriculum(This thesis is copyrighted)</li>
							<li>Year - 2007-2009</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 50,000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>Dr. R. V. Tadas</b>
						<ul>
							<li>Topic of Research - To draw out thevalue reflected in the science text books at secondary level</li>
							<li>Year - 2009-2011</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 27,000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>Dr. A. G .Watkar</b>
						<ul>
							<li>Topic of Research - Analytical study of Brahmakumari with reference to personality development.</li>
							<li>Year - 2008-2010</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 30,000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>D.r S. M. Ganoje</b>
						<ul>
							<li>Topic of Research - Comparative study of global warming awareness among senior college teachers of various streams</li>
							<li>Year - 2009-2011</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 35,000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>Dr. M.N.Khatal</b>
						<ul>
							<li>Topic of Research - A study of environmental awarenessin reference to new curriculum.</li>
							<li>Year - 2008-2010</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 50,000</li>
						</ul>
					...
					<div>
						<b>Dr G.k.Mankar</b>
						<ul>
							<li>Topic of Research - Analytical study of educational values in the abhangas of Sant Tukaram.</li>
							<li>Year - 2009-2011</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 50,000</li>
						</ul>
					...
					<hr>
					<div>
						<b>Dr.A.S.Dharaskar</b>
						<ul>
							<li>Topic of Research - Analytical studies of educational thoughts of Sant Gadgebaba with reference to D Ed/B Ed curriculum.</li>
							<li>Year - 2008-2010</li>
							<li>Funding Agency - UGC</li>
							<li>Amount - Rs 25,000</li>
						</ul>
					</div>
					<hr>
					<div>
						<b>Dr S.U.Samudre</b>
						<ul>
							<li>Topic of Research - Effectiveness of the Enquiry Teaching Model in the development of scientific attitude of the middle school students – an experimental study.</li>
							<li>Year - 201-2013</li>
							<li>Funding Agency - UGC</li>
							<li>Amount -Rs 80,000</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="achievement_college.php"><div class="rightbtn">Achievements-College</div></a>
					<a href="#"><div class="rightbtn">Achievements-Faculty</div></a>
					<a href="#"><div class="rightbtn">Achievements-Students</div></a>
				</div>
			</div>
			<!-- right div end -->
