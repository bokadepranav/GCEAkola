...
<html>
<head>
<title>Research Project - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Research Projects</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Downloads</a>|
		<a href="" class="qwklink">Research Projects</a>
	</div>
	...
	<div class="container">
		<div class="row">
				...
				<div class="leftdiv">
					<table width="100%">
						<tr align="center" style="background-color: rgb(94, 12, 12); color: white; border-color: white;">
							<td class="tblbd" width="25%"><b>Name</b></td>
							<td class="tblbd" width="25%"><b>Subject</b></td>
							<td class="tblbd" width="25%"><b>Year</b></td>
							<td class="tblbd" width="25%"><b>Funding Agency</b></td>
						</tr>		
						<tr align="center">
							<td class="tblbd">Dr. S. G.Bute	</td>
							<td class="tblbd">A Critical Study of Educational Values in Sant Janabai’s Abhangas	</td>
							<td class="tblbd">2008-2010	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr. V. V.Deo	</td>
							<td class="tblbd">An Analytical Study of Educational Thoughts of Swami Chinmayanand with reference to New Curriculum</td>
							<td class="tblbd">2007-2009	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr.R.V.Tadas	</td>
							<td class="tblbd">To Draw Out the Values in the Textbook of Science at Secondary Level</td>
							<td class="tblbd">2009-2011	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr. S. M. Ganoje	</td>
							<td class="tblbd">Comparative Study of Global Warming Awareness among Senior College Teachers of Various Streams.</td>
							<td class="tblbd">2009-2011	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr Mohan Khatal	</td>
							<td class="tblbd">A Study of Awareness through the Subject Environment with reference to New Syllabus.	</td>
							<td class="tblbd">2008-2010	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr Gokarna Mankar	</td>
							<td class="tblbd">A Critical Study of Educational Values in Sant Tukaram’s Abhangas.</td>
							<td class="tblbd">200-2011	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr Asha Dharaskar	</td>
							<td class="tblbd">An Analytical Study of Educational Thoughts of Sant Gadgebaba with reference to D Ed and B Ed New curriculum.	</td>
							<td class="tblbd">2008-2010	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr A.G.Watkar	</td>
							<td class="tblbd">A Study of Relationship between Emotional Maturity and Teaching Effectiveness.	</td>
							<td class="tblbd">2013-2015	</td>
							<td class="tblbd">UGC</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr. S. U. SAMUDRE	</td>
							<td class="tblbd">"EFFECTIVENESS OF ENQUIRY TRAINING MODEL IN DEVELOPING THE SCIENTIFIC ATTITUDE OF MIDDLE SCHOOL STUDENTS - AN EXPERIMENTAL STUDY”.	</td>
							<td class="tblbd">2011-2013	</td>
							<td class="tblbd">UGC</td>
						</tr>
					</table>
					<br>
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="research_paper.php"><div class="rightbtn">Research Papers</div></a>
					<a href="research_project.php"><div class="rightbtn">Research Projects</div></a>
				</div>
			</div>
			<!-- right div end -->
