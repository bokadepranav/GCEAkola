...
<html>
<head>
<title>Research Paper - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Research Paper</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Research Papers</a>
	</div>
				...
				<div class="leftdiv">
					<table width="100%">
						<tr align="center" style="background-color: rgb(94, 12, 12); color: white; border-color: white;">
							<td class="tblbd" width="30%"><b>Faculty Name</b></td>
							<td class="tblbd" width="40%"><b>Subject</b></td>
							<td class="tblbd" width="30%"><b>Click to See</b></td>
						</tr>		
						<tr align="center">
							<td class="tblbd">Dr. A. G. Watkar</td>
							<td class="tblbd" style="	font-family: 'Hind', sans-serif;">शिक्षकांची भावनिक परिपक्वता व अध्यापन परिणामकारता यातील सहसंबंधाचा अभ्यास</td>
							<td class="tblbd"><a href="">View</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd">Dr. A. G. Watkar</td>
							<td class="tblbd">Teacher Effectiveness: A New Trend in Education	</td>
							<td class="tblbd"><a href="">View</a></td>
						</tr>
						<tr align="center">
						...
						<tr align="center">
							<td class="tblbd">Dr. A. G. Watkar</td>
							<td class="tblbd">New Learning Technology</td>
							<td class="tblbd"><a href="">View</a></td>
						</tr>
						<tr align="center">
							<td class="tblbd"></td>
							<td class="tblbd">The Final Report of the Work done on the Project</td>
							<td class="tblbd"><a href="">View</a></td>
						</tr>
					</table>
					<br>
