...
<html>
<head>
<title>Admission - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Admission</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Admission</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<p>
						The Govt. college of Education is offering admissions to Regular B.Ed and Vacational B.Ed degree course. For more details please call : 0724-2437389 email principalakola80@gmail.com Admission to Regular B.Ed course is done through CET Exam conducted by Director of Higher Education, Maharastra State,Pune.
					</p>
					<h5 class="bodyhdtxt">Regular B.Ed:</h5>
					<b>Regular B.Ed: annual intake capacity 50 seats (one unit)</b>
					<p>
						The Admission process is carried out by (CET CELL) GOVERNMENT OF MAHARASHTRA STATE COMMON ENTRANCE TEST CELL, MAHARASHTRA STATE, MUMBAI<br>
						8th Floor, New Excelsior Building,<br>
						A.K. Nayak Marg, Fort, Mumbai, 400001<br>
						E-mail - maharashtra.cetcell@gmail.com<br>
						Phone Nos:- 022-22016153/57/59<br>
						Website - www.mahacet.org
					</p>
					<h5 class="bodyhdtxt">Other Courses of Y.C.M.O.U. Nasik :</h5>
					<p>
						Admission process is carried out by open university. University sends the list of selected candidates to the college.
					</p>
				</div>
			</div>
			<!-- left div end -->
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="#"><div class="rightbtn">Fees Structure</div></a>
				</div>
			</div>
			<!-- right div end -->
