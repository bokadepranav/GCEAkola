...
<html>
<head>
<title>Library - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Library</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Library</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9 col-lg-9">
				<div class="leftdiv">
					<p>
						The college has prosperous Library with various types of books and related resource in different field of education. Which includes Encyclopedia text book, latest Journals, Audio-Vusials and e-media. Library facility is equiped with special reading room for students and Teachers it has open access system for the students.<br><br>

						The library is computerized. The software Inflib net Soul 2.0 is used for computerization. All the books are enlisted on the software. The institution library has Computer, Internet and Reprographic facilities. Faculties and students frequently use these facilities.
					</p>
					<table width="100%">
						<tr align="center" style="background-color: rgb(94, 12, 12); color: white; border-color: white;">
							<td class="tblbd"><b>S.n</b></td>
							<td class="tblbd"><b>Particular</b></td>
							<td class="tblbd"><b>Quantity</b></td>
						</tr>		
						<tr align="center">
							<td class="tblbd">1</td>
							<td class="tblbd">Total Books</td>
							<td class="tblbd">23,489</td>
						</tr>
						<tr align="center">
							<td class="tblbd">2</td>
							<td class="tblbd">e-books</td>
							<td class="tblbd">51,746</td>
						</tr>
						<tr align="center">
							<td class="tblbd">3</td>
							<td class="tblbd">Volumes</td>
							<td class="tblbd">600</td>
						</tr>
						<tr align="center">
							<td class="tblbd">4</td>
							<td class="tblbd">Titles</td>
							<td class="tblbd">1,100</td>
						</tr>
						<tr align="center">
							<td class="tblbd">5</td>
							<td class="tblbd">Journals- National</td>
							<td class="tblbd">4</td>
						</tr>
						<tr align="center">
							<td class="tblbd">6</td>
							<td class="tblbd">Journals- International</td>
							<td class="tblbd">1</td>
						</tr>
						<tr align="center">
							<td class="tblbd">7</td>
							<td class="tblbd">Journals- e-journals</td>
							<td class="tblbd">2154</td>
						</tr>
						<tr align="center">
							<td class="tblbd">8</td>
							<td class="tblbd">Magazines</td>
							<td class="tblbd">26</td>
						</tr>
						<tr align="center">
							<td class="tblbd">9</td>
							<td class="tblbd">Audio / Video Resources</td>
							<td class="tblbd">96</td>
						</tr>
						<tr align="center">
							<td class="tblbd">10</td>
							<td class="tblbd">Internet Access</td>
							<td class="tblbd">Available Wifi</td>
						</tr>				
					</table><br><br>
					<h5 style="color: rgb(94, 12, 12);">A Library Committee is set up to look after the library working. The Committee is as follows:</h5><br>
					<table width="100%">
						<tr align="center" style="background-color: rgb(94, 12, 12); color: white; border-color: white;">
							<td class="tblbd"><b>Chairman</b></td>
							<td class="tblbd"><b>Dr. Vasudha V. Deo (Principal)</b></td>
						</tr>		
						<tr align="center">
							<td class="tblbd">Secretary</td>
							<td class="tblbd">vacant <br> Librarian</td>
						</tr>
						<tr align="center">
							<td class="tblbd">Members</td>
							<td class="tblbd">Dr. Vasudha V. Deo<br> Dr. Rohini Tadas<br> Shri. Anant B.Dandekar (Office member)<br> Shri. Sanket S.Raut ( C.H.B. Librarian)</td>
						</tr>
					</table>
					<br>
					<img src="image/Library.jpg" class="bdimg">
				</div>
			</div>
			<!-- left div end -->
