...
<html>
<head>
<title>Gallary-Videos - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Video-Gallary</h5></div>
</div>
<!-- page heading end -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<div class="rightdiv">
					<a href="gallary_page.php"><div class="rightbtn">Photo Gallary</div></a>
					<a href="#"><div class="rightbtn">Video Gallary</div></a>
				</div>
			</div>
			<!-- right div end -->
