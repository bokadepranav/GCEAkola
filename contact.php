...
<html>
<head>
<title>Contact - Govt College Of Education</title>
...
<!-- page heading start -->
<div>
	<div class="hdline"><h5 class="hdlinetxt">Contact</h5></div>
</div>
<!-- page heading end -->
...
<!-- quick link div start -->
	...
	<div class="lightbg">
		...
		<a href="" class="qwklink">Contact</a>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-md-6 col-lg-6">
				<div class="leftdiv">
					<h5 class="bodyhdtxt">Government College of Education</h5>
					<div>
						<table>
							<tr>
								<td><img src="image/location1.jpg" class="contactimg"></td>
								<td><a href="contact.php" class="cntctxt">Near Akola Netra Hospital, Ramdaspeth, Akola, Dist:Akola(Maharashtra)</a></td>
							</tr>
							<tr>
								<td><img src="image/mobilephone.jpg" class="contactimg"></td>
								<td><a href="contact.php" class="cntctxt">0724 - 2433765</a></td>
							</tr>
							<tr>
								<td><img src="image/mail1.jpg" class="contactimg"></td>
								<td><a href="contact.php" class="cntctxt">principalakola80@gmail.com</a></td>
							</tr>
						</table>
						<br>
						<h5 class="bodyhdtxt">Principal</h5>
						<table>
							<tr>
								<td><img src="image/mobilephone.jpg" class="contactimg"></td>
								<td><a href="contact.php" class="cntctxt">0724 - 2433765 (O)</a></td>
							</tr>
							<tr>
								<td><img src="image/mail1.jpg" class="contactimg"></td>
								<td><a href="contact.php" class="cntctxt">principalakola80@gmail.com</a></td>
